...
public class SearchFiles {
    ...
    public static ArrayList<File> indexSearch(String keywords, String type1) {
        //String res = "";
...
//            1、创建Directory
            FSDirectory directory = FSDirectory.open(Paths.get("/Users/alexsun/IdeaProjects/Information_Retrieval/IR_Project1_final/src/main/webapp/statics/index"));//在硬盘上生成Directory
//            2、创建IndexReader
...
//        path = "/Users/alexsun/IdeaProjects/Information_Retrieval/data/" + path;
    ...
    public static void main(String[] args) throws IOException {
        ArrayList<File> ooo = indexSearch("math", "fulltext");
