...
<div class="jumbotron" style="text-align: center;background: rgba(0,0,0,0)">
    <h1 style="font-family:'NEOTERICc - Bold DEMO VERSION'; color: white">Information Retrieval Project</h1>
    <div class="row">
        <p><br><br></p>
    </div>
    <p style="font-family:'NEOTERICc - Bold DEMO VERSION'; color: white">
        TASK: Parse Metadata & Text form PDFs<br>
        TASK: Index & Search the Parsed Metadata from Grobid<br>
        TASK: Build a Simple Web Search Engine with the Index<br><br>
        Ray Andrew LP Ryan
    </p>
    <p></p>
    <p></p>
    ...
    <div style="text-align: center">
        <a class="btn btn-lg"
           style="color: white;border-style: solid;border-width: 1px;border-color:white;font-family:'NEOTERICc - Bold DEMO VERSION'"
           href="html/Search.html" role="button">Learn more</a>
    </div>
    </p>
</div>
