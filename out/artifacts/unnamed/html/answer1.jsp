    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <span> <%=lp2.get(i).getHighlight()%></span><br>
            </div>
 ...
 for(int j=0;j<5;j++){
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
            <div class="panel-heading">
                <b>
                    <a href="./Search?action=displayTxt&amp;dblpId=285660&amp;sourceRadio=ms " target="_blank"><%=lp2.get(j).getTitle()%></a>
                    &nbsp;
                    <sup>
                        <a href="http://archixl.nl/files/wicsa_referencearchitecture.pdf" target="_blank">[pdf]</a>
                    </sup>
            ...
            <div>
                <span><b>Score: ？？？</b></span><br>
                <span><b>DblpAuthors: </b><%=lp2.get(j).getAuthor()%></span><br>
                <span><b>DblpPages: </b><%=lp2.get(j).getPage()%></span><br>
                <span><b>DblpYear: </b> <%=lp2.get(j).getDate()%></span><br>
                <span><b><a href="./Search?action=displayGraph&amp;dblpId=285660&amp;sourceRadio=ms" target="_blank">display related papers</a></b></span><br>
                <span> <%=lp2.get(j).getHighlight()%></span><br>
            </div>
            <div class="panel-footer">
                <span><b><a href="./Search?action=displayGraph&amp;dblpId=285660&amp;sourceRadio=ms" target="_blank">Related Papers</a></b></span><br>
            </div>
...
<div class="col-md-8 col-md-offset-4">
    <nav aria-label="Page navigation">
        <ul class="pagination pagination-lg">
            ...
            <li><a href="/search2?keyword=<%=keyword2%>&page=1">1</a></li>
            <li><a href="/search2?keyword=<%=keyword2%>&page=2">2</a></li>
            <li><a href="/search2?keyword=<%=keyword2%>&page=3">3</a></li>
            <li><a href="/search2?keyword=<%=keyword2%>&page=4">4</a></li>
            <li><a href="/search2?keyword=<%=keyword2%>&page=5">5</a></li>
            <li><a href="/search2?keyword=<%=keyword2%>&page=6">6</a></li>
            <li>
